 ...
 * });
 *
 * @param {function(context:Object, message:Record, conversation:Record, participants:Record[])} func - function to be registered
 */
...
export function afterMessageSent(func) {
  chatHook('after_message_sent', (args, context) => {
    ...
    func(context, message, conversation, participants);
  });
}
 ...
 *
 * @param {function(context:Object, conversation:Record, participants:Record[], event:Object)} func - function to be registered
 */
...
export function typingStarted(func) {
  chatHook('typing_started', (args, context) => {
    const conversation = new Conversation(args.conversation);
    const participants = args.participants.map((p) => new User(p));
    func(context, conversation, participants, args.events);
  });
}
 ...
 *
 * @param {function(context:Object, conversation:Record, participants:Record[])} func - function to be registered
 */
...
export function afterConversationCreated(func) {
  chatHook('after_conversation_created', (args, context) => {
    const conversation = new Conversation(args.conversation);
    const participants = args.participants.map((p) => new User(p));
    func(context, conversation, participants);
  });
}
 ...
 *
 * @param {function(context:Object, conversation:Record, participants:Record[], newUsers:Record[])} func - function to be registered
 */
...
export function afterUsersAddedToConversation(func) {
  chatHook('after_users_added_to_conversation', (args, context) => {
    ...
    func(context, conversation, participants, newUsers);
  });
}
 ...
 *
 * @param {function(context:Object, conversation:Record, participants:Record[], oldUsers:Record[])} func - function to be registered
 */
...
export function afterUsersRemovedFromConversation(func) {
  chatHook('after_users_removed_from_conversation', (args, context) => {
    ...
    func(context, conversation, participants, oldUsers);
  });
}
